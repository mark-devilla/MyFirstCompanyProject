...
<?php 
include('admin/dist/includes/dbcon.php');
...
$systemnameko_unsafe=$_POST['systemnamelabel'];

$user = mysql_real_escape_string($user_unsafe);
$pass1 = mysql_real_escape_string($pass_unsafe);
$systemnameko = mysql_real_escape_string($systemnameko_unsafe);
...
$query=mysql_query("select * from user where username='$user' and password='$pass' and system_name='$systemnameko' and status='active'")or die(mysql_error);
	$row=mysql_fetch_array($query);
	  ...
	  $_SESSION['name']=$name;
		...
		mysql_query("INSERT INTO history_log(user_id,action,date) VALUES('$id','$remarks','$date')")or die(mysql_error);
